...
const PresalePanel = () => {
    ...
    return (
        <div className="border-spacing-11 bg-gradient-to-b from-[#ffffff5d]  to-[#4ef7565d] my-5 flex flex-col items-center p-6 rounded-xl shadow-lg max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-2 text-green-800 font-bold font-roboto">Buy before the price goes up!</p>
            ...
            <div className="mt-2 w-full">
                ...
                <input type="text" id="solanaAddress" className="p-1 rounded text-green-800 w-full" placeholder="your SOLANA address" />
            </div>
