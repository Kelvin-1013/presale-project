  ...
  return (
    <div className='overflow-hidden '>
      ...
      >
        ...
        <img
          className='absolute z-0 object-cover w-full h-full pointer-events-none '
          src={props.sectionImg}
          alt=''
        />


        <div className='z-20 flex flex-col items-center justify-center w-full h-full px-10 text-3xl text-center text-cC md:px-4 sm:text-4xl md:text-6xl'>

          <div className='z-20 px-2 py-2 bg-cB rounded-2xl md:px-4 opacity-80'>
