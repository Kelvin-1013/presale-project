...
const Faqs = (props) => {
    ...
    return (
        ...
        <details key={props.id} className="bg-white rounded-[18px] border-[#0D6EFD] border-[3px] border-opacity-30 py-[24px] sm:py-[34px] md:py-[42px] px-[24px] sm:px-[32px] md:px-[38px]">
            <summary className="outline-none hover:cursor-pointer text-[18px] sm:text-[20px] md:text-[22px] font-medium text-[#0D6EFD] ">
